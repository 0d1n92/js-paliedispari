...
function fxComparation(arg1, arg2) { return arg1==arg2; } //ritorna vero se la condizione è vera(se hai scritto pari ed è uscito un numero pari)
function fxEven(arg1){ return number%2==0; }//ritorna vero se la condizione è vera
function fxNumberBot (max,min){ return Math.floor(Math.random()*(max - min))+min; }
